...
DEFAULT_MODEL_DIR = Path(
    "/home/metamobility2/JiminMM2/IDL Project/Jimin_IDL_AccelOnly/IDL_AccelOnly"
)
DEFAULT_OUTPUT_CSV = DEFAULT_MODEL_DIR / "AB07_Leo_accel_only_speed_metrics.csv"
...
def load_trial(trial_dir, model_dir, label_cutoff_freq, zero_0mps_labels):
    ...
    input_r = input_imu[["Thigh_R_Acc_X", "Thigh_R_Acc_Y", "Thigh_R_Acc_Z"]].values
    input_l = input_imu[["Thigh_L_Acc_X", "Thigh_L_Acc_Y", "Thigh_L_Acc_Z"]].values
    input_l[:, 1] *= -1
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Evaluate IDL AccelOnly offline inference on all AB07 trials grouped by speed."
    )
    parser.add_argument("--data-root", default=str(DEFAULT_DATA_ROOT))
    parser.add_argument("--subject", default="AB07_Leo")
    parser.add_argument("--model-dir", default=str(DEFAULT_MODEL_DIR))
    parser.add_argument("--model-name", default="IDL_AccelOnly")
